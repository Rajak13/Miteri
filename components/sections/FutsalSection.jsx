    ...
    >
      <div className="w-full max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-6 lg:gap-10 items-center">
        ...
        <div ref={contentRef} className="col-span-12 md:col-span-7 flex flex-col justify-center gap-4 sm:gap-6 z-10 pl-0 lg:pl-4">
          {/* Category Tag (Architype Stedelijk + #3CCB6E accent) */}
          <div className="inline-flex items-center gap-2.5 px-3.5 py-1.5 rounded-md bg-[#3CCB6E]/10 border border-[#3CCB6E]/20 w-fit">
            <span className="w-2 h-2 rounded-full bg-[#3CCB6E] animate-pulse" />
            <span className="font-stedelijk text-xs sm:text-sm font-bold tracking-widest uppercase text-[#3CCB6E]">
              01 / FUTSAL ARENA
            </span>
          </div>
          ...
          <h2
            className="font-humane font-bold uppercase text-[#0D0D0E] leading-[0.84] tracking-[-0.01em]"
          ...
          {/* CTA Button (Architype Stedelijk) */}
          <div className="pt-1">
            <button
            ...
            >
              ...
              <span className="w-5.5 h-5.5 sm:w-6.5 sm:h-6.5 rounded-full bg-[#3CCB6E] text-[#0D0D0E] flex items-center justify-center transition-transform duration-300 group-hover:rotate-45 shrink-0">
